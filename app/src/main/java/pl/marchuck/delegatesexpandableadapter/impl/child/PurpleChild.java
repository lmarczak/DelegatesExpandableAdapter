 ...
 * @since 15.02.16
 */
public class PurpleChild implements DelegableChild {
    ...
    @Override
    public void onBindChildViewHolder(AbstractExpandableItemViewHolder holder, int groupPosition,
    ...
    public AbstractExpandableItemViewHolder onCreateChildViewHolder(ViewGroup parent, int viewType) {
        View v = DelegatesManager.inflateMe(parent, R.layout.item_2);
    ...
    public static class MyViewHolder extends AbstractExpandableItemViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            textView = (TextView) itemView.findViewById(R.id.purple_child);
